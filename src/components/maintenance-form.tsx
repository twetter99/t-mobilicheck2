...
const steps = [
  { id: 1, name: 'Cabecera', fields: ['header'] },
  ...
  const handleAiValidation = async () => {
    ...
    if (result.success) {
      toast({
        ...
        description: 'No se han encontrado anomalías en los datos.',
        variant: 'default',
        ...
        toast({
            ...
            description: result.error || 'No se ha podido completar la validación con IA.',
            variant: 'destructive',
          });
    }
